...
//guy that hangs from ceiling
//little spider guy
public class Spider extends Enemy {
	
	private BufferedImage[] sprites;
	//these needed bc addition of web thing
	...
	public Spider(TileMap tm, int webx, int weby) {
		...
		try {
			...
			BufferedImage spritesheet = ImageIO.read(getClass().getResourceAsStream("/enemySprites/spider.gif"));
	...
	private void getNextPosition() {
		...
		//this guy only moves up and down
		// movement
		if(up) {
			dy -= moveSpeed;
			if(dy < -maxSpeed) {
